...
class Milk:
    ...
    def table(self):
        ...
        self._set_product_category(cells=['E5', 'F5', 'G5', 'H5', 'I5'])
        self._set_value(product, "C5")
        self._set_value('Да', 'O5')
        self._set_value('Не подлежит', 'AL5')
        self._set_value('7', 'AM5')
        self._set_value('Фабрика Фабрика', 'AS5')
        self._set_value('Российская Федерация', 'AV5')
        self._set_value('БЕЗ БРЕНДА', 'AW5')
        self._set_value('Не релевантно', 'AY5')
        self._set_value('шт', 'AZ5')
        self._set_value('ПЭТ', 'BA5')
        self._set_value('1', 'BB5')
        self._set_value('0402 Молоко и сливки, сгущенные или с добавлением сахара или других подслащивающих веществ:', 'BF5')
        self._set_value('10.51.11.121 Молоко питьевое коровье ультрапастеризованное (ультравысокотемпературно-обработанное)', 'BG5')
        self._set_value('20', 'BH5')
        self._set_value('', 'BJ5')
        self._set_value('456543456567', 'BK5')
        self._set_value('1', 'BL5')
        self._set_value('200', 'BM5')
        self._set_value('75', 'BN5')
        self._set_value('75', 'BO5')
        self._set_value('ПЭТ-ПАК', 'BQ5')
        self._set_value('ПОЛИЭТИЛЕНТЕРЕФТАЛАТ (ПЭТ/ПЭТФ)', 'BR5')
        self._set_value('14603421406173', 'CB5')
        self._set_value('16', 'CC5')
        self._set_value('16', 'CD5')
        self._set_value('300', 'CE5')
        self._set_value('320', 'CF5')
        self._set_value('320', 'CG5')
        self._set_value('ПЭТ-ПАК', 'CI5')
        self._set_value('ПОЛИЭТИЛЕНТЕРЕФТАЛАТ (ПЭТ/ПЭТФ)', 'CJ5')
